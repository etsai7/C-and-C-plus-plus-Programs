...
void Student::action(int answer)
{
    ...
    {
        cout << "You entered an invalid action. Please try again." << endl;
    }
}
/*--------------------------------------------------------------------*/
void Student::add_course(int subject,const  string course)
{
...
void Student::study()
{
    ...
    if(z == -1)
    {
        cout << "Course not Found. Could not study." << endl;
    }   
}
...
{
    int score = 0;
    int z = -1;     /*This is just a indicator whether there is the course*/
    string letter_grade;
    string course_name;
    cout << "Courses:" << endl;
    this->print_courses();
